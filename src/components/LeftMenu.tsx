...
const LeftMenu = () => {
    return (
        <LeftMenuWrapper>
            ...
            <path d="M419.013 397C396.341 428.822 354.836 443.064 305.578 439.915C256.355 436.768 199.725 416.245 147.436 378.99C95.1468 341.736 57.2547 294.913 38.2047 249.417C19.141 203.888 19.0475 160.008 41.7198 128.186C64.3921 96.3647 105.897 82.1224 155.155 85.2717C204.378 88.4188 261.008 108.942 313.297 146.196C365.586 183.451 403.478 230.274 422.528 275.77C441.592 321.298 441.685 365.179 419.013 397Z" stroke="#2521FF" stroke-width="4"/>
            <path d="M439.526 35.9502C453.123 44.8963 459.841 62.0558 459.279 83.0654C458.718 104.04 450.879 128.518 435.79 151.45C420.701 174.383 401.324 191.269 382.284 200.085C363.212 208.916 344.795 209.537 331.198 200.59C317.601 191.644 310.883 174.485 311.445 153.475C312.006 132.501 319.845 108.023 334.934 85.0903C350.023 62.1576 369.4 45.2715 388.44 36.4555C407.512 27.6247 425.93 27.0041 439.526 35.9502Z" stroke="#FF7E21" stroke-width="4"/>
            </svg>
        </LeftMenuWrapper>
    )
}
